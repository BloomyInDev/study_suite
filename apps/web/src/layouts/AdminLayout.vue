...
<template>
  <div class="d-flex" style="height: 100%">
    ...
    <v-navigation-drawer v-if="mobile" v-model="drawerOpen" temporary>
      <div class="text-center text-caption font-weight-bold text-uppercase pa-4 text-medium-emphasis">
        Administration
      </div>
      <v-divider />
      <v-list nav>
    ...
    <nav
      v-if="!mobile"
      style="width: 256px; min-width: 256px; border-right: thin solid rgba(var(--v-border-color), var(--v-border-opacity))"
    >
      <div class="text-center text-caption font-weight-bold text-uppercase pa-4 text-medium-emphasis">
        Administration
      </div>
